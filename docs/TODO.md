...
5. [ ] Replace synthetic glucose generator with timestamp-aligned replay/live sensor stream for CGM model input.
...
11. [ ] Create and stage updated golden/failsafe restore points after model-quality improvements.
12. [ ] Commit and push the updated project state to GitHub.
